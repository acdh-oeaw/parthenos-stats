...
title = "ChartGeneratingQueries_Overall"
...
queries = [
    {
        "title": "InstancesCount_PieChart_Overall",
        "query": r"""
    ...
    {
        "title": "InstancesCountAndClassHierarchy_SankeyChart_Overall",
    ...
    # {
    #     "title" : "TopRelationsOfInstancesPerClass_Overall",
    #     "query" : r"""
    #
    #         select
    #
